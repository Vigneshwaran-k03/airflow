...
from services.universal.schema_typesense import universal_schema
from services.universal.transformations import transform_universal_data


def push_universal_to_typesense(
    parquet_file: str,
    collection_name: str,
    batch_size: int,
):
    """
    Stream universal Parquet files into Typesense safely.
    ...
    schema = universal_schema(collection_name)
    try:
    ...
    lf = transform_universal_data(lf)
