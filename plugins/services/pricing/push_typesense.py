...
from services.pricing.schema_typesense import pricing_schema
from services.pricing.transformations import transform_pricing_data


def push_pricing_to_typesense(
    parquet_file: str,
    collection_name: str,
    batch_size: int = 5_000,
):
    """
    Stream pricing Parquet files into Typesense safely.
    ...
    schema = pricing_schema(collection_name)
    try:
