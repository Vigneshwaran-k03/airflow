...
from services.technical.schema_typesense import technical_schema
from services.technical.transformations import transform_technical_data


def push_technical_to_typesense(
    parquet_file: str,
    collection_name: str,
    ...
    schema = technical_schema(collection_name)
    try:
