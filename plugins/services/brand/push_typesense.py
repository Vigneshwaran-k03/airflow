...
from services.brand.schema_typesense import typesense_schema
from services.brand.transformations import transform_data


def push_brands_to_typesense(
    parquet_file: str,
    collection_name: str,
    batch_size: int = 1_000,
):
    """
    Stream a single Parquet file into Typesense safely.
    """
    ...
    # Optional transformations that are lazy-compatible
