...
from services.category.schema_typesense import typesense_schema
from services.category.transformations import transform_category_data


def push_categories_to_typesense(
    parquet_file: str,
    collection_name: str,
