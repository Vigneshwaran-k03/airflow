...
from services.characteristics_piece.schema_typesense import characteristics_piece_schema
from services.characteristics_piece.transformations import transform_characteristics_piece_data


def push_characteristics_piece_to_typesense(
    parquet_file: str,
    collection_name: str,
    batch_size: int = 10_000,
):
    """
    Stream characteristics_piece Parquet files into Typesense safely.
    ...
    schema = characteristics_piece_schema(collection_name)
    try:
    ...
    lf = transform_characteristics_piece_data(lf)
